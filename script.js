  ...
  overlay.innerHTML = `
    <div class="receipt-box payment-modal">
      ...
      <div class="payment-card">
        ...
        <p class="payment-note">Nominal transfer sesuai total pesanan. Setelah transfer, kami akan menghubungi kamu lewat WhatsApp untuk proses lanjut.</p>
      </div>
    ...
    confirmBtn.addEventListener("click", () => {
      ...
      showReceiptModal(`
        <div class="receipt-modal">
          ...
          <div class="receipt-note">🏦 Pembayaran via SeaBank: 901809290073<br/>📱 Pesananmu sudah kami kirimkan ke WhatsApp untuk diproses.</div>
